...
export default function TeoriaMusical() {
  ...
  // If user is not the super admin (cristianbordon186@gmail.com), show the Coming Soon screen
  if (!canManageTheory) {
    return (
      <div className="w-full min-h-[100dvh] bg-[#0a0e17] text-slate-100 flex flex-col overflow-x-hidden relative">
        {/* Cinematic Ambient Glow */}
        <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
          <div
            className="absolute -top-1/4 -right-1/4 w-[600px] h-[600px] rounded-full opacity-30"
            style={{
              background: "radial-gradient(circle, hsl(270 80% 60% / 0.15) 0%, transparent 70%)",
            }}
          />
          <div
            className="absolute -bottom-1/4 -left-1/4 w-[500px] h-[500px] rounded-full opacity-20"
            style={{
              background: "radial-gradient(circle, hsl(220 90% 60% / 0.12) 0%, transparent 70%)",
            }}
          />
        </div>

        {/* Top Header */}
        <header className="sticky top-0 z-40 bg-[#0a0e17]/90 backdrop-blur-xl border-b border-white/10 px-4 py-3.5 flex items-center justify-between">
          ...
          <Badge className="bg-purple-500/20 text-purple-300 border-purple-500/40 text-[11px] font-bold px-3 py-1 uppercase tracking-wider">
            En Desarrollo
          </Badge>
        </header>

        {/* Coming Soon Body */}
        <main className="flex-1 p-4 sm:p-8 max-w-3xl w-full mx-auto relative z-10 flex flex-col justify-center items-center text-center my-auto py-12">
          {/* Animated Icon Glow */}
          <motion.div
          ...
          >
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-3xl bg-gradient-to-tr from-purple-600/30 via-indigo-500/20 to-purple-400/30 border border-purple-500/40 flex items-center justify-center shadow-2xl shadow-purple-600/30">
              <GraduationCap className="w-12 h-12 sm:w-14 sm:h-14 text-purple-300 animate-pulse" />
            </div>
            <div className="absolute -top-2 -right-2 p-2 rounded-2xl bg-amber-500/20 border border-amber-500/40 text-amber-300">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-300 text-xs font-black uppercase tracking-widest mb-4 shadow-sm"
          >
          ...
          >
            Academia Musical Privilegiados
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-xl mb-8 font-medium"
          >
            Estamos preparando cursos exclusivos, lecciones interactivas, técnicas vocales e instrumentales y material de estudio para capacitar y elevar la excelencia de los músicos y directores de alabanza.
          </motion.p>
          ...
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full mb-8 text-left"
          >
            <div className="p-4 rounded-2xl bg-slate-900/80 border border-white/10 space-y-1 backdrop-blur-md">
              <div className="flex items-center gap-2 text-purple-400 font-bold text-xs">
                <Piano className="w-4 h-4" /> Cursos por Instrumento
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Lecciones paso a paso para Piano, Guitarra acústica y eléctrica, Bajo y Batería.
              </p>
            </div>

            <div className="p-4 rounded-2xl bg-slate-900/80 border border-white/10 space-y-1 backdrop-blur-md">
              <div className="flex items-center gap-2 text-blue-400 font-bold text-xs">
                <Mic className="w-4 h-4" /> Técnica Vocal y Dirección
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Ejercicios de respiración, armonías a varias voces y liderazgo espiritual en la alabanza.
              </p>
            </div>

            <div className="p-4 rounded-2xl bg-slate-900/80 border border-white/10 space-y-1 backdrop-blur-md">
              <div className="flex items-center gap-2 text-emerald-400 font-bold text-xs">
                <FileText className="w-4 h-4" /> Material y Partituras
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Guías en PDF, diagramas de acordes, círculos armónicos y material de práctica descargable.
              </p>
            </div>

            <div className="p-4 rounded-2xl bg-slate-900/80 border border-white/10 space-y-1 backdrop-blur-md">
              <div className="flex items-center gap-2 text-amber-400 font-bold text-xs">
                <Star className="w-4 h-4" /> Seguimiento y Progreso
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">
                Mide tu crecimiento y marca las lecciones completadas junto a los integrantes de tu equipo.
              </p>
            </div>
          </motion.div>
          ...
          >
            <Button
              ...
              className="h-12 px-6 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs uppercase tracking-wider shadow-lg shadow-purple-600/30"
            >
              Explorar Canciones
            </Button>
            <Button
              variant="outline"
              onClick={() => navigate("/")}
              className="h-12 px-6 rounded-2xl bg-white/5 border-white/10 hover:bg-white/10 text-slate-200 font-bold text-xs uppercase tracking-wider"
            >
              Volver al Inicio
            </Button>
          </motion.div>
  ...
  return (
    <div className="w-full min-h-[100dvh] bg-[#0a0e17] text-slate-100 flex flex-col overflow-x-hidden">
      {/* Clean Native Android Top Header for Super Admin */}
      <header className="sticky top-0 z-40 bg-[#0a0e17]/95 backdrop-blur-xl border-b border-white/10 px-4 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-purple-300 font-bold">Panel Super Admin (cristianbordon186@gmail.com)</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="h-9 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold px-3.5 text-xs flex items-center gap-1.5 shadow-md shadow-purple-600/30"
          >
            <Plus className="w-4 h-4" /> <span>Agregar Curso / Recurso</span>
          </Button>
        </div>
      </header>
