    ...
    <main className="flex-1 min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-30 bg-background/80 backdrop-blur-xl border-b border-border px-4 py-3">
        <div className="max-w-lg mx-auto flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold">Crear Grupo Musical</h1>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-8">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          >
            ...
            >
              <Avatar className="w-28 h-28 rounded-2xl border-2 border-dashed border-secondary/30 group-hover:border-secondary/60 transition-all">
                <AvatarImage src={logoPreview || undefined} className="object-cover rounded-2xl" />
          ...
          <p className="text-[11px] text-center text-muted-foreground/60 font-medium">
            ...
            Podrás invitar miembros compartiendo el enlace del grupo.
          </p>
        </form>
      </div>
    </main>
