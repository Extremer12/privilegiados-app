        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex flex-col gap-2 min-w-0 flex-1">
              ...
              <h3 className="text-xl sm:text-2xl font-bold tracking-tight text-white leading-tight mt-1 line-clamp-2">
                {setlist.title}
              </h3>
            </div>
            
            <div className="shrink-0">
              <div className="bg-white/5 rounded-2xl p-2 sm:p-3 border border-white/5 flex flex-col items-center min-w-[45px] sm:min-w-[60px]">
          ...
          {/* Secondary Info */}
          {setlist.preacher && (
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2.5 bg-white/[0.03] rounded-2xl border border-white/5">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mt-2">
            <div className="flex gap-3 flex-1">
              <Button
                onClick={onView}
                className="flex-1 h-12 sm:h-14 rounded-2xl bg-white/5 hover:bg-white/10 text-white font-bold text-sm transition-all border border-white/5"
              >
            ...
            <div className="flex gap-3 sm:w-auto">
              {onDuplicate && (
                <Button
                  ...
                  variant="ghost"
                  className="flex-1 sm:h-14 sm:w-14 h-12 rounded-2xl bg-white/5 hover:bg-secondary/10 text-secondary/60 hover:text-secondary transition-all border border-white/5"
                  title="Duplicar"
                >
